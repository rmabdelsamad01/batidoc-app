...
async function openLodAllProjects(){
  ...
  var results=await Promise.all([
    sb.from('project_info').select('project,key,value').in('project',projectIds).in('key',['deliverables','visa_statuses','intervenants','file_descriptions']),
  ...
  var projData=projects.map(function(proj){
    ...
    var fileDesc=info.file_descriptions||{};
    return {proj:proj,projVisa:projVisa,projIv:projIv,bgKey:bgKey,delivRows:delivRows,fileDesc:fileDesc};
  });
    ...
    pd.delivRows.forEach(function(dr,di){
      ...
      var subRows=dr.files.map(function(f,fi){
        ...
        return '<tr style="background:#f0f5ff;border-bottom:1px solid rgba(34,79,147,0.05);">'
          ...
          +subDelayedTd
          +planCols.map(function(col,ci){var fd=f.expected_date?_parseFileDate(f.expected_date):null;var hit=fd&&fd>=col.start&&fd<=col.end;return '<td style="padding:5px 8px;font-size:11px;text-align:center;color:'+(hit?'#224F93':'#d0dae6')+';font-weight:'+(hit?'700':'400')+';'+(ci===0?'border-left:2px solid #e0e8f4;':'')+(ci===8?'border-left:2px solid #e0e8f4;':'')+';">'+(hit?'1':'—')+'</td>';}).join('')
          +'</tr>';
      }).join('');
...
// ── Excel Export ──────────────────────────────────────────────
var _LOGO_B64="";
var _BATIGED_LOGO_B64="";
...
function _exAddHeader(wb,ws,projName,dateStr,totalCols){
  var bg='FFF0F4FA';
  var rCols=3;
  var rStart=Math.max(totalCols-rCols+1,6);
  ...
  var pnCell=r1.getCell(3);
  pnCell.value=projName;
  pnCell.font={bold:true,size:14,name:'Arial',color:{argb:'FF1A2A3A'}};
  pnCell.alignment={vertical:'bottom',horizontal:'left'};
  var nameEnd=rStart-2;
  if(nameEnd>=3) ws.mergeCells(r1.number,3,r1.number,nameEnd);
  var autoCell=r1.getCell(rStart);
  autoCell.value='Automatically generated from:';
...
async function exportFolderToExcel(){
  ...
  _exStyleHeaderRow(ws.addRow(_headers));
...
async function exportAllDeliverablesToExcel(){
  ...
  _exSetColumns(ws);
  _exAddHeader(wb,ws,projName,_dateStr,totalCols);
