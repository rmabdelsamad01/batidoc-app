...
function _exAddHeader(wb,ws,projName,dateStr,totalCols){
  var bg='FFF0F4FA';
  var imgId=wb.addImage({base64:_LOGO_B64,extension:'png'});
  ws.addImage(imgId,{tl:{col:0,row:0},ext:{width:130,height:55}});
  var r1=ws.addRow([]);
  r1.height=32;
  for(var c=1;c<=totalCols;c++) r1.getCell(c).fill={type:'pattern',pattern:'solid',fgColor:{argb:bg}};
  var pnCell=r1.getCell(2);
  ...
  lkCell.alignment={vertical:'middle',horizontal:'center'};
  var r3=ws.addRow([]);
  r3.height=8;
